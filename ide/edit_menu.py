...
class Edit():
    ...
    def executeCode(self, *args):
        compiler.compile(self.text.get(0.0, END))
...
def main(root, text, menubar):
    ...
    editmenu.add_command(label="Build and run", command=objEdit.executeCode, accelerator="Ctrl+F9")
    ...
    root.bind_all("<Control-F9>", objEdit.executeCode)
    ...
    objEdit.rightClick.add_command(label="Build and run", command=objEdit.executeCode)
